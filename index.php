...
<body class="bg-light">
  ...
  <div class="container availability-form">
    <div class="row">
      <div class="con-lg-12 bg-white shadow p-4 rounded">
        <h5 class="mb-4">Check Booking Availability<h5>
          <div class="row align-items-end">
            <div class="col-lg-3 mb-3">
              <label class="form-label custom-label">Check in</label>
              <input type="date" class="form-control shadow-none">
            </div>
            <div class="col-lg-3 mb-3">
              <label class="form-label custom-label" >Check out</label>
              <input type="date" class="form-control shadow-none">
            </div>
            <div class="col-lg-3 mb-3">
              <label class="form-label custom-label">Adult</label>
            ...
            <div class="col-lg-2 mb-3">
              <label class="form-label custom-label">Children</label>
              <select class="form-select shadow-none">
                <option value="1">One</option>
                <option value="2">Two</option>
                <option value="3">Three</option>
